...
class Detector:
    ...
    def __init__(self, model_name="default"):
        ...
        model_folder = os.path.join("/root/.NudeNet")
        if not os.path.exists(model_folder):
            os.makedirs(model_folder)

        checkpoint_name = os.path.basename(checkpoint_url)
        checkpoint_path = os.path.join("/root/.NudeNet/default/detector_v2_default_checkpoint.onnx")
        classes_path = os.path.join("/root/.NudeNet/detector_v2_default_classes")
